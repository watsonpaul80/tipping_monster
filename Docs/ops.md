...
2.  **Fetch Betfair Odds (Hourly)**
    ...
    *   **Command:** `bash /home/ec2-user/tipping-monster/utils/safecron.sh odds_hourly /home/ec2-user/tipping-monster/.venv/bin/python /home/ec2-user/tipping-monster/core/fetch_betfair_odds.py`
...
4.  **Calibrate Confidence Daily (`roi/calibrate_confidence_daily.py`)**
    ...
    *   **Command:** `bash /home/ec2-user/tipping-monster/utils/safecron.sh calibrate_conf /home/ec2-user/tipping-monster/.venv/bin/python /home/ec2-user/tipping-monster/roi/calibrate_confidence_daily.py`
...
6.  **Generate Master Subscriber Log & Upload (`roi/generate_subscriber_log.py`)**
    ...
    *   **Command:** `/home/ec2-user/tipping-monster/.venv/bin/python /home/ec2-user/tipping-monster/roi/generate_subscriber_log.py --date $(date +\%F) && aws s3 cp /home/ec2-user/tipping-monster/logs/roi/master_subscriber_log.csv s3://tipping-monster-data/master_subscriber_log.csv`
...
6.  **ROI Calculation:** Results are compared against sent tips to calculate ROI. `roi/generate_subscriber_log.py` creates a master log in `logs/roi/`, and `roi/run_roi_pipeline.sh` processes these for summaries (logged in `logs/roi/`).
