    ...
    try:
        ...
        for mkt, book in zip(markets, all_price_data):
            try:
                ...
                total_market_volume = round(book.total_matched, 2) if book.total_matched else 0
                ...
                for runner, runner_book in zip(mkt.runners, book.runners):
                    ...
                    volume = round(runner_book.total_matched, 2) if runner_book.total_matched else 0
        ...
        print(f"[+] Saving {len(all_data)} runner odds + volume to {output_path}")
